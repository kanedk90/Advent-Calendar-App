...
function scene:createScene( event )
	...
	local title = display.newText( "14 days to go!", 160, 40, native.systemFontBold, 38 )
        title:setTextColor( .75, 0, 0)
        group:insert(title)
        
        --created the level image
        local levelImage = display.newImage("images/level011.png", 160, 240)
        levelImage: scale(0.5, 0.5)
